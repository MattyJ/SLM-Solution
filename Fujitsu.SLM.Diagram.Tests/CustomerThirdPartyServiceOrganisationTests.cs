...
{
    [TestClass]
    public class CustomerThirdPartyServiceOrganisationTests
    {
        ...
        public void TestInitilize()
        {
                ...
                new ServiceComponent
                {
                    ...
                    Resolver = new Resolver
                    {
                        ...
                        ServiceDeliveryOrganisationType =
                            _serviceDeliveryOrganisationTypes.FirstOrDefault(x => x.Id == 3),
            ...
            _diagramGenerator = new CustomerThirdPartyServiceOrganisation(_serviceDeskService, _serviceComponentService);
        ...
        public void CustomerThirdPartyServiceOrganisation_Constructor_NoServiceDeskService()
        {
            #region Arrange
            ...
            new CustomerThirdPartyServiceOrganisation(
                null,
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void CustomerThirdPartyServiceOrganisation_Constructor_NoServiceComponentService()
        {
            #region Arrange
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void CustomerThirdPartyServiceOrganisation_Generate_ServiceDeskIdSetToZero()
        {
            #region Arrange
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_CallsServiceGetById()
        {
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartAsListOfChartDataViewModel()
        {
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartWithServiceDeskTypeAsParent()
        {
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartWithSixInputs()
        {
            var result = _diagramGenerator.Generate(1, false, false, true, true, true);
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartWithTwoResolversBothWithParentComponentsChildComponentsAndActivities()
        {
            var result = _diagramGenerator.Generate(2, false, false, true, true, true);
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartWithTwoResolvers()
        {
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartWithTwoResolversBothWithTwoComponents()
        {
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartWithTwoResolversBothWithOneServiceActivity()
        {
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartWithTwoResolversWithCorrectServiceActivities()
        {
            var result = _diagramGenerator.Generate(2, false, false, false, true, true);
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ComponentsOnlyReturnsChartWithFourComponents()
        {
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ReturnsChartWithParentComponentsChildComponentsAndActivities()
        {
        ...
        [TestMethod]
        public void CustomerThirdPartyServiceOrganisation_Generate_ActivitiesOnlyReturnsChartWithFiveActivities()
        {
