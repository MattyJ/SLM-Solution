...
{
    [TestClass]
    public class FujitsuServiceOrganisationTests
    {
        ...
        public void FujitsuServiceOrganisation_Constructor_NoServiceDeskService()
        {
            #region Arrange
            ...
            new FujitsuServiceOrganisation(
                null,
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void FujitsuServiceOrganisation_Constructor_NoServiceComponentService()
        {
            #region Arrange
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void FujitsuServiceOrganisation_Generate_ServiceDeskIdSetToZero()
        {
            #region Arrange
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_CallsServiceGetById()
        {
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartAsListOfChartDataViewModel()
        {
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartWithServiceDeskTypeAsParent()
        {
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartWithSixInputs()
        {
            var result = _diagramGenerator.Generate(1, false, false, true, true, true);
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartWithTwoResolversBothWithParentComponentsChildComponentsAndActivities()
        {
            var result = _diagramGenerator.Generate(2, false, false, true, true, true);
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartWithTwoResolvers()
        {
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartWithTwoResolversBothWithTwoComponents()
        {
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartWithTwoResolversBothWithOneServiceActivity()
        {
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartWithTwoResolversWithCorrectServiceActivities()
        {
            var result = _diagramGenerator.Generate(2, false, false, false, true, true);
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ComponentsOnlyReturnsChartWithFourComponents()
        {
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ReturnsChartWithParentComponentsChildComponentsAndActivities()
        {
        ...
        [TestMethod]
        public void FujitsuServiceOrganisation_Generate_ActivitiesOnlyReturnsChartWithFiveActivities()
        {
            var result = _diagramGenerator.Generate(2, false, false, false, false, true);

            Assert.IsNotNull(result);
            var units = result.First().Units.ToList();
