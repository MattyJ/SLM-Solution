...
{
    public class FujitsuServiceOrganisation : IDiagramGenerator
    {
        ...
        public FujitsuServiceOrganisation(IServiceDeskService serviceDeskService, IServiceComponentService serviceComponentService)
        {
            ...
            _serviceOrganisationDiagramtype = ServiceDeliveryOrganisationNames.Fujitsu;
        }
