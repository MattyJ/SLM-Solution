...
namespace Fujitsu.SLM.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IAuthenticationManager authenticationManager, IContextManager contextManager)
        {
            if (userManager == null)
            {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            //var user = _contextManager.UserManager.ApplicationUser;
            var user = _userManager.FindById(_contextManager.UserManager.User.Identity.GetUserId());
            var result = await _userManager.ChangePasswordAsync(user.Id, model.OldPassword, model.NewPassword);
            if (result.Succeeded)
            {
                //await _signInManager.SignInAsync(_contextManager.UserManager.ApplicationUser, isPersistent: false, rememberBrowser: false);
                await _signInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);
